...
#predicted_children_probabilities
predicted_children = ifelse(predicted_children_probabilities>0.5,1,0)
#confusion_out=table(y=test$children,yhat=predicted_children)
